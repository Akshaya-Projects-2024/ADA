            ...
            <View style={styles.content}>
              ...
              <View>
                ...
                <View style={styles.locationMain}>
                  <View style={{ width: "50%" }}>
                    <Text style={styles.lastSeenText}>Last seen location:</Text>
                  ...
                  <View style={styles.w40}>
                    <Text style={styles.lastSeenDate}>Last Seen Date</Text>
                    <Text numberOfLines={1} style={styles.lastDate}>
                      03/06/2024
                    </Text>
                  </View>
                </View>
                <Text style={styles.petDescription}>
                  If you have any information or have seen Sheru, please contact
                  immediately. Let's bring Sheru home safely!
                </Text>
